...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            @role('admin')
            <a href="/ppm/create">
                <button class="btn btn-success mb-3"><i class="fa fa-plus"></i> Tambah PPM</button>
            </a>
            @endrole
            <div class="row mb-4">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#tabel').DataTable({
                ...
                columns: [
                    ...
                    { data: 'tanggal_pelaksanaan', name: 'd.tanggal_pelaksanaan' },
        ...
        async function hapusData(id) {
            ...
            if (result.value) {
                try {
                    await axios.delete(`/ppm/${id}`);

                    $('#tabel').DataTable().ajax.reload();

                    toastr.success('PPM berhasil dihapus');
                } catch (e) {
