    ...
    <div class="card">
        ...
        <div class="card-body">
            <a href="/webinar/create">
                <button class="btn btn-success mb-3"><i class="fa fa-plus"></i> Tambah Webinar</button>
            </a>
            <div class="row mb-4">
                @role('admin')
...
@push('scripts')
    <script>
            ...
            $('#tabel').DataTable({
                ...
                columns: [
                    ...
                    { data: 'nama', name: 'p.nama' },
                        @endrole
                    {
                        data: 'materi_pengembangan', name: 'w.materi_pengembangan'
                    },
                    { data: 'tanggal_pelaksanaan', name: 'w.tanggal_pelaksanaan' },
                    { data: 'jumlah_jam', name: 'w.jumlah_jam' },
                    { data: 'berkas', name: 'w.filename' },
        ...
        async function hapusData(id) {
            ...
            if (result.value) {
                try {
                    await axios.delete(`/webinar/${id}`);

                    $('#tabel').DataTable().ajax.reload();

                    toastr.success('Webinar berhasil dihapus');
                } catch (e) {
