...
@section('content')
    ...
    <div class="card" x-data="form" id="formComponent">
        <div class="card-header">
            <h3 class="card-title">{{ isset($seminar) ? 'Ubah' : 'Tambah' }} Data Seminar</h3>
        </div>
    ...
    <script>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('form', () => ({
                ...
                async initData(id) {
                    let res = await axios.get(`/seminar/${id}`);
                    let data = res.data;
                ...
                async submit() {
                    ...
                    try {
                        if (id) {
                            ...
                            await axios.post(`/seminar/${id}`, formData);
                        } else {
                            await axios.post('/seminar', formData);
                        }
